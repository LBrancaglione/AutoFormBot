...
# Press win+r and type the url and open the web site in the default browser
...
with open("membros.csv") as f:
    ...
    for line in f:
        ...
        pyautogui.click(
            pyautogui.locateCenterOnScreen("img\\email.png", confidence=0.8), duration=1
        )
        pyautogui.typewrite(email, interval=0.25)

        pyautogui.click(
            pyautogui.locateCenterOnScreen("img\\telefone.png", confidence=0.8),
            duration=1,
        )
        pyautogui.typewrite(phone, interval=0.25)

        pyautogui.click(
            pyautogui.locateCenterOnScreen("img\\sexo.png", confidence=0.8),
            duration=1,
        )
        if sex == "Masculino":
            pyautogui.click(
        ...
        pyautogui.click(
            pyautogui.locateCenterOnScreen("img\\botao_enviar.png", confidence=0.8),
            duration=1,
        )
